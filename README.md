...
- [Levels Of Self Governance Endpoints](https://api.100levelup.com/openapi.json) - Governance and audit services for agent systems, USDC on Base via x402: MCP-config governance lint (POST /x402/audit-mcp, $0.05), audit verification (GET /x402/verify-audit, $0.005), plus legal-prep, bookkeeping, and agent-therapy endpoints. Free discovery at [/scan](https://api.100levelup.com/scan).
